...
describe('markdown-it-link-attributes', function () {
  ...
  it('allows custom attributes to be added to link', function () {
    ...
    let result = this.md.render('[link](https://example.com|aria-labelledBy=some-id)');
  ...
  it('applies "true" to custom attributes with no value', function () {
    ...
    let result = this.md.render('[link](https://example.com|hidden)');
  ...
  it('does not apply custom attributes to any other links', function () {
    ...
    let link1 = '[link 1](https://example.com|aria-labelledBy=some-id|hidden)';
    let link2 = '[link 2](https://example.com)';
    let result = this.md.render(link1 + link2);
  ...
  it('allows multiple rules', function () {
    ...
    let result = this.md.render('[Google](https://www.google.com)');
